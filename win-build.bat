...
:package
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%PROJECT_ROOT%\win-build.ps1" -Package
...
:usage
echo Usage: win-build.bat [clean] [build] [package] [all]
echo.
echo Commands:
...
echo.
echo Example: win-build.bat clean build
goto end
